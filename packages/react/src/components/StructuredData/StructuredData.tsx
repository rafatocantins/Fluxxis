...
import { generateDualModeRender, createStructuredDataScript } from '@fluxxis/core';
import type { DataFormatType } from '@fluxxis/core';
...
export const StructuredData: React.FC<StructuredDataProps> = ({
    ...
    const render = generateDualModeRender(
        children ? (children as any).toString() : '',
        schemaType,
        data,
        agentFormat
    );
